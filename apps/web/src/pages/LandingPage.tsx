  ...
  return (
    ...
    >
      ...
      <g>
        ...
        <rect x="240" y="144" width="36" height="18" rx="9" fill="var(--ff-violet-light)" />
...
function StepCard({ number, title, description, accentBg, accentColor, delay = 0 }: StepCardProps) {
  const { ref, visible } = useReveal();
  ...
  return (
    <div
      ...
      className="relative bg-card border border-border rounded-[--radius-xl] p-7
                 flex flex-col gap-4 hover:-translate-y-1
                 hover:shadow-[0_8px_32px_-8px_rgba(92,74,228,0.10)]
                 transition-all duration-300"
    >
      {/* Numero step */}
      <div
...
export function LandingPage() {
  ...
  return (
    <div className="min-h-screen bg-background overflow-x-hidden">
      ...
      <section className="relative pt-32 pb-24 px-6">
        ...
        >
          <div
            ...
            style={{ background: "radial-gradient(circle, var(--ff-violet-light) 0%, transparent 70%)", opacity: 0.5 }}
          />
          <div
            className="absolute top-40 -left-40 w-[400px] h-[400px] rounded-full"
            style={{ background: "radial-gradient(circle, var(--ff-amber-light) 0%, transparent 70%)", opacity: 0.5 }}
          />
        </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            >
              ...
              <h1 className="font-display text-4xl sm:text-5xl lg:text-[3.4rem]
                ...
                <span className="relative inline-block" style={{ color: "var(--ff-violet)" }}>
                  finalmente
                  <svg viewBox="0 0 160 10" fill="none" className="absolute -bottom-1 left-0 w-full"
                    preserveAspectRatio="none" aria-hidden="true">
                    <path d="M2 7 Q40 2 80 6 Q120 10 158 5" stroke="var(--ff-amber)"
              ...
              <div className="flex flex-wrap items-center gap-3 pt-2">
                ...
                <Link
                  ...
                  className="inline-flex items-center gap-2 px-6 py-3.5
                             ...
                             rounded-[--radius-pill] text-sm border border-border
      ...
      {/* ── COME FUNZIONA ─────────────────────────────────── */}
      <section className="py-24 px-6 bg-[--ff-sand]/30">
        <div className="max-w-5xl mx-auto">
          <div className="text-center mb-14">
            <p className="text-xs font-medium tracking-widest uppercase text-[--ff-violet] mb-3">
              Come funziona
            </p>
            ...
            <p className="mt-4 text-muted-foreground text-base max-w-md mx-auto leading-relaxed">
              Nessuna configurazione complessa. Sei operativo in meno di un minuto.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-5">
            <StepCard
              ...
              description="Registrati in pochi secondi. Nessuna carta di credito richiesta, nessun limite artificiale."
              accentBg="var(--ff-violet-light)"
              accentColor="var(--ff-violet-dark)"
              delay={0}
            />
            <StepCard
              number="2"
              title="Aggiungi i tuoi task"
              description="Inserisci le attività, assegna priorità, scadenze e categorie. Tutto in un posto solo."
              accentBg="var(--ff-teal-light)"
              accentColor="var(--ff-teal)"
              delay={80}
            />
            <StepCard
              number="3"
              title="Resta in controllo"
              description="Dashboard, calendario e filtri avanzati per avere sempre chiaro cosa fare e quando."
              accentBg="var(--ff-amber-light)"
              accentColor="var(--ff-amber-dark)"
              delay={160}
            />
          </div>
        </div>
      ...
      <section className="py-24 px-6" id="features">
        <div className="max-w-5xl mx-auto">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-2 gap-5">
            <FeatureCard
              icon={<IconTasks />} accent="violet" delay={0}
            ...
            />
            <FeatureCard
              icon={<IconCalendar />} accent="amber" delay={80}
            ...
            />
            <FeatureCard
              icon={<IconFilter />} accent="teal" delay={160}
            ...
            />
            <FeatureCard
              icon={<IconSearch />} accent="coral" delay={240}
      ...
      <footer className="border-t border-border py-10 px-6">
        <div className="max-w-5xl mx-auto flex flex-col sm:flex-row
          ...
          <span className="font-display text-lg text-foreground select-none">FocusFlow</span>
          <p className="text-xs text-muted-foreground">Fatto per chi ha cose da fare.</p>
          <Link to="/login" className="text-xs text-[--ff-violet] hover:underline underline-offset-4 transition-all">
            Accedi →
          </Link>
        </div>
      </footer>
